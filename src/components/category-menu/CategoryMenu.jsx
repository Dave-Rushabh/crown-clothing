...
const CategoryMenu = () => {
  const categories = [
    ...
    },
    {
      ...
      title: "Men's",
      imageUrl:
        "https://images.unsplash.com/photo-1542550445-15fa54828a6f?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870",
    },
  ];
